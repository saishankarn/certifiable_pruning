...
class LeNet5(nn.Module):
    def __init__(self, num_classes=10):
        ...
        self.conv1 = nn.Conv2d(1, 6, 5)  # Convolutional Layer 1: input channels=1, output channels=6, kernel size=5x5
...
name = 'lenet5_mnist_pfp'
net = LeNet5(num_classes=10).to(device)
...
def get_dummy_net(compressed_modules):
    compressed_net = LeNet5(num_classes=10)
...
# Plot the data
plt.plot(keep_ratios, error_percent_replication, '-o', label='pruned loss')
...
# Set the title
plt.title('LeNet-5 pruning statistics - replication')

# Set the legend
plt.legend()

# Show the plot
plt.savefig('lenet5_prune_stats.png')
